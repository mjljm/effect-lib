...
import { MeqValue } from '#src/internal/index';
...
export const strictEquals = common.function_strictEquals;

export const isEquivalentTo = common.function_isEquivalentTo;

export const flipDual = common.function_flipDual;
